...
import { FlavorUploadImages } from './flavor-upload-images';
...
export function ItemFlavor({
  ...
  return (
    <>
      <div className='mb-2 flex w-full cursor-grab items-center gap-2'>
        ...
        <div className='border-line flex h-full w-full items-center justify-between gap-3 rounded-md border bg-white p-3'>
          ...
          {dishFlavorsMedias.length > 0 && (
            <Image
              src={
                process.env.NEXT_PUBLIC_BUCKET_URL + dishFlavorsMedias[0].url
              }
              alt=''
              ...
              <Tooltip>
                ...
                <Tooltip.Content sideOffset={5}>
                  ...
                  <p>
                    ...
                    descrição específica para o sabor, será exibida a descrição
                    da aba <strong>&quot;detalhes&quot;</strong>.
                  </p>
                  <p>
                  ...
                  <p>
                    3. Se você cadastrar descrições em ambas as abas, será
                    exibida a descrição da aba{' '}
            ...
            <Tooltip>
              <Tooltip.Trigger asChild>
                <IconCameraUp
                  ...
                  onClick={() => setIsModalUploadImageOpen(true)}
                />
              </Tooltip.Trigger>
              <Tooltip.Content sideOffset={5}>
                Atualizar imagens
      ...
      >
        <Modal.Wrapper title='Atualizar imagens' size='lg' hideActionButton>
          <div className='pt-4'>
            <FlavorUploadImages
              id={id}
              flavorImages={dishFlavorsMedias}
              dishId={dish.data.id}
            />
          </div>
        </Modal.Wrapper>
