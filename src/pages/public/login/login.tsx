...
export function Login() {
  ...
  return (
    <div className='w-screen z-0 h-screen bg-[url(/assets/images/bg-admin.jpg)] bg-no-repeat bg-center bg-cover relative after:absolute after:inset-0 after:bg-black/40 after:z-[-1] overflow-hidden'>
